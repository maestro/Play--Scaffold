...
public class FormElement {
  ...
  private final FormElementType formElementType;
  ...
  public FormElement(Field field, FormElementType formElementType, List<Object> options) {
  ...
  public FormElement(String fieldName, Class<?> fieldType, FormElementType formElementType, List<Object> options) {
    this.name = fieldName;

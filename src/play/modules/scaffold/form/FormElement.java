...
public class FormElement {
	...
	public FormElement(Field field, FormElementType formElementType,
			List<Object> options) {
	...
	public FormElement(FormElement copy, Class<?> fieldType,
			FormElementType formElementType) {
		this(copy.name, fieldType, formElementType, copy.options);
	}

	public FormElement(String fieldName, Class<?> fieldType,
			FormElementType formElementType, List<Object> options) {
		this.name = fieldName;
		...
		if (formElementType == FormElementType.EMBEDDED) {
			...
			List<FormElement> childFormElements = this.fieldAsEntity
					.getFormElements();
	...
	public boolean isRadio() {
		return formElementType == FormElementType.RADIO;
	}
